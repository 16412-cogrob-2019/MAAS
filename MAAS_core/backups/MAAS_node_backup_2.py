...
############################# Subscriber Callback functions ####################
    ...
    def mcts_data_callback_deprecated(self, data):
	...
	print(type(message["sample"]))
	print(message["sample"][0])
	print(type(message["sample"][0]))
	print("--------------------------------------------------------------------------------")
	#message_ = json.loads(message["sample"])
	print("-----------------------------------")
	#print(type(message["sample"]))
	#print(type(message["sample"]["x"]))
	sample = message["sample"][0]
	print(sample)
	print("-----------------------------------")
	# get the agent_id, x and y and z locations of the agent's location, measurement type (e.g. depth), and measurement value 
	...
	measurement_value = sample["measurement_value"]
 	...
 	self.json_dict['sample_values'].append({"x": x, "y": y,  "z": z, "measurement_type":measurement_type, "measurement_value":measurement_value})
